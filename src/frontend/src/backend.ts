...
export class Backend implements backendInterface {
    ...
    async deleteProcessed(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteProcessed();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getSubmissionCount(arg0: boolean): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getSubmissions(arg0: boolean): Promise<Array<ContactSubmission>> {
        if (this.processError) {
            try {
    ...
    async markAllProcessed(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markAllProcessed();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markAsProcessed(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markAsProcessed(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchByEmail(arg0: string): Promise<Array<ContactSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchByEmail(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
